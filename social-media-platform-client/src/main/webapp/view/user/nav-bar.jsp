	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/view/user/notification.jsp"> <i class="fa fa-globe">
							<span class="badge badge-success">11</span>
					</i> Notification
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/view/user/messages.jsp"> <i class="fa fa-envelope-o">
